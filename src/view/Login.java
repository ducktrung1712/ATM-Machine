...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Chào quý khách");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtSTK, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnDangnhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangnhapActionPerformed
        ...
        if (phone.isEmpty() || pin.isEmpty()) {
            showMessage("Số điện thoại và mã PIN không được để trống!");
            return;
        }

        Customer customer = customerController.login(phone, pin);
        if (customer != null) {
            ...
            showMessage("Sai số điện thoại hoặc mã PIN!");
        }
    }//GEN-LAST:event_btnDangnhapActionPerformed
    public String getPhone() {
        return txtSTK.getText();
    }

    public String getPIN() {
        return new String(txtMaPIN.getPassword());
    }
